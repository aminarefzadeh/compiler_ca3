...
public interface SmoolaListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SmoolaParser#identifier}.
	 * @param ctx the parse tree
	 */
	void enterIdentifier(SmoolaParser.IdentifierContext ctx);
	/**
	 * Exit a parse tree produced by {@link SmoolaParser#identifier}.
	 * @param ctx the parse tree
	 */
	void exitIdentifier(SmoolaParser.IdentifierContext ctx);
}